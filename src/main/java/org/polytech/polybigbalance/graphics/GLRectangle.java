 ...
 */
public class GLRectangle extends Displayable
{
     ...
     */
    public GLRectangle(Vec2 position, Vec2 dimension, Color color, Shader shader)
    {
        super(shader);
     ...
     */
    public GLRectangle(Vec2 position, Vec2 dimension, Color color, String pathVertexShader, String pathFragmentShader)
    {
     ...
     * @param pathFragmentShader path to the file containing the fragment shader's code
     */
    public GLRectangle(Vec2 position, Vec2 dimension, String pathVertexShader, String pathFragmentShader)
    {
